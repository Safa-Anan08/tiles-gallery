...
export default function TileDetails() {
  ...
  const {
    ...
    toggleWishlist,
    loading: wishLoading,
  } = useWishlist(tile, user);

  const {
    isCartAdded,
    toggleCart,
  } = useCartButton(tile, user);
        ...
        <div className="p-6 md:p-10 space-y-6">
          ...
          <div className="pt-4">
            ...
            <button
              onClick={toggleCart}
              className={`
                mt-4 flex items-center gap-2 px-6 py-3 rounded-full
                font-semibold shadow-lg transition-all hover:scale-105
                ${
                  isCartAdded
                    ? "bg-gray-700 text-white"
